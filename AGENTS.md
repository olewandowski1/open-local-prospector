...
- [`CHANGELOG.md`](CHANGELOG.md) follows [Keep a Changelog](https://keepachangelog.com/en/1.0.0/).
  Review it before every commit and record each notable technical or product change under
  `Unreleased`. Include behavior, architecture, compatibility, fixes, and security. Omit
  documentation presentation and repository housekeeping.
