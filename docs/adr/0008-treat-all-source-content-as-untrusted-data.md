...
Browser inspection also blocks localhost, private-network destinations, file and custom protocols, downloads, pop-ups, and unexpected navigation. Authentication barriers, CAPTCHAs, access controls, and rate limits are recorded rather than bypassed. These controls apply identically to every supported runtime.
