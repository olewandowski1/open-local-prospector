...
Business discovery and identity corroboration use the web-search capability of the runtime selected in the Search Brief: Codex, Claude Code, or OpenCode. The application does not require a separate search API, key, account, or fallback provider. This supersedes ADR 0005's Brave Search decision.
