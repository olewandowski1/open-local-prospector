...
Status: Amended By [ADR 0013](0013-search-then-structure.md)

Business discovery and identity corroboration use the web-search capability of the runtime selected in the Search Brief: Codex, Claude, or OpenCode. The application does not require a separate search API, key, account, or fallback provider. This supersedes ADR 0005's Brave Search decision.
