...
export function buildSearchPrompt(request: DiscoverySearchRequest): string {
  return [
    ...
    'Title is the business\'s own trading name only. Strip any publisher, directory or website name from it: return "Kwiaciarnia Koniczynka", never "Kwiaciarnia Koniczynka - SomeDirectory.pl".',
    'A page listing several businesses is not a business. Exclude category pages, "best of" and ranking pages, articles, schools, and generic directories.',
    "If one business appears on several sites, return it once, preferring its own website over any directory profile.",
